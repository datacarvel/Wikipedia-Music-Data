...
head(EdgelistClean) <- unique(EdgelistPreClean)

nrow(EdgelistClean)

write.csv(EdgelistClean[1:400,], file = "EdgelistCleanSubset.csv")
write.csv(EdgelistClean, file = "EdgelistClean.csv")

EdgelistClean[EdgelistClean[, "From"] == "new wave of british heavy metal",]

write.csv(EdgelistClean[EdgelistClean[, "From"] == "punk rock",], file = "EdgelistCleanPunkRock.csv")
